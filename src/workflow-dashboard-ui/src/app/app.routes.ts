...
export const routes: Routes = [
  ...
  { path: 'catalog', loadComponent: () => import('./pages/catalog/catalog').then(m => m.CatalogPage), title: 'Catalog — Workflow Dashboard' },
  { path: 'catalog/:kind/:slug', loadComponent: () => import('./pages/catalog/catalog-detail').then(m => m.CatalogDetailPage), title: 'Catalog — Workflow Dashboard' },
